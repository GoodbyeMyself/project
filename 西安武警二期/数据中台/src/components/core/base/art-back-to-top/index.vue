<!-- 返回顶部按钮 -->
<template>
  <!-- Auto Comment: Component Summary: This component renders UI for '数据中台/src/components/core/base/art-back-to-top/index.vue'. -->
...
<script setup lang="ts">
  // Auto Comment: Component Script Notes: This script block manages state, events, and data flow for '数据中台/src/components/core/base/art-back-to-top/index.vue'.
