<!-- 折线图卡片 -->
<template>
  <!-- Auto Comment: Component Summary: This component renders UI for '指标体征管理平台/src/components/core/cards/art-line-chart-card/index.vue'. -->
...
<script setup lang="ts">
  // Auto Comment: Component Script Notes: This script block manages state, events, and data flow for '指标体征管理平台/src/components/core/cards/art-line-chart-card/index.vue'.
