<!-- 系统聊天窗口 -->
<template>
  <!-- Auto Comment: Component Summary: This component renders UI for '数据共享交换平台/src/components/core/layouts/art-chat-window/index.vue'. -->
...
<script setup lang="ts">
  // Auto Comment: Component Script Notes: This script block manages state, events, and data flow for '数据共享交换平台/src/components/core/layouts/art-chat-window/index.vue'.
