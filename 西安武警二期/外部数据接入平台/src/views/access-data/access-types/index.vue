<template>
  <!-- Auto Comment: Component Summary: This component renders UI for '外部数据接入平台/src/views/access-data/access-types/index.vue'. -->
...
<script setup lang="ts">
  // Auto Comment: Component Script Notes: This script block manages state, events, and data flow for '外部数据接入平台/src/views/access-data/access-types/index.vue'.
  // Auto Comment: Maintenance Hint: Keep business rules explicit and avoid implicit side effects between handlers.
  defineOptions({ name: 'AccessTypes' })

  // Logic Note: Reactive state 'typeCards' stores mutable runtime data used by this component.
  const typeCards = ref([
    {
      name: '表接入',
